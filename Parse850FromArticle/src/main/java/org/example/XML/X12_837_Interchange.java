 ...
 */
@Data
@JsonRootName("X12_837_Interchange")
public class X12_837_Interchange {
    ...
    public static class Loop2300ClaimInformation {
        ...
        @JacksonXmlElementWrapper(useWrapping = false)
        @JsonProperty("Loop_2310A_ReferringProviderName")
        private List<X12_837_Loop2310_Classes.Loop2310AReferringProviderName> loop2310AReferringProviderName;

        // Loop 2310B - Rendering Provider Name
        @JsonProperty("Loop_2310B_RenderingProviderName")
        private X12_837_Loop2310_Classes.Loop2310BRenderingProviderName loop2310BRenderingProviderName;

        // Loop 2310C - Service Facility Location Name
        @JsonProperty("Loop_2310C_ServiceFacilityLocationName")
        private X12_837_Loop2310_Classes.Loop2310CServiceFacilityLocationName loop2310CServiceFacilityLocationName;

        // Loop 2310D - Supervising Provider Name
        @JsonProperty("Loop_2310D_SupervisingProviderName")
        private X12_837_Loop2310_Classes.Loop2310DSupervisingProviderName loop2310DSupervisingProviderName;

        // Loop 2310E - Ambulance Pick-up Location
        @JsonProperty("Loop_2310E_AmbulancePickupLocation")
        private X12_837_Loop2310_Classes.Loop2310EAmbulancePickupLocation loop2310EAmbulancePickupLocation;

        // Loop 2310F - Ambulance Drop-off Location
        @JsonProperty("Loop_2310F_AmbulanceDropoffLocation")
        private X12_837_Loop2310_Classes.Loop2310FAmbulanceDropoffLocation loop2310FAmbulanceDropoffLocation;
